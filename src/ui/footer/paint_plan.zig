...
pub fn composeFooterFrame(
    ...
    else if (input.show_picker and input.picker_kind == .model_stage)
        try input_presentation.composeModelPickerHintRow(alloc, shell.layout.cols, ctx.ctrl_c_pending)
