...
pub fn supported(comptime App: type) bool {
    return @hasField(App, "provider_selection") or
        (@import("builtin").is_test and @hasField(App, "selected_model"));
}
...
pub fn model(app: anytype) []const u8 {
    ...
    if (comptime @import("builtin").is_test and @hasField(App, "selected_model")) {
...
pub fn provider(app: anytype) model_provider.ProviderId {
    ...
    if (comptime @import("builtin").is_test and @hasField(App, "selected_provider")) {
